...
export class DramaboxScraper {
    ...
    async getDramaDetailV2(bookId) {
        try {
            ...
            const data = await this.request(`/webfic/book/detail/v2?id=${bookId}&language=${this.language}`, { id: bookId, language: this.language }, true, 'GET');
...
//# sourceMappingURL=Dramabox.js.map